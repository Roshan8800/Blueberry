...
describe('App Navigation History Bug', () => {
  ...
  it('correctly restores internal history after Browser Back and Forward', async () => {
    // Mock fetchVideos to return some videos so HOME view shows the banner
    vi.mocked(fetchVideos).mockResolvedValue({ success: true, data: [{ id: '1', title: 'Test Video', author: 'Test', category: 'Test', thumbnail: '', duration: '0:00', views: '0', embedUrl: '', description: '', rating: 0, tags: [] }] });
